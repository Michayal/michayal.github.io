...
var Elem =
    [ { elemName: 'Elem0', nodeA: 6, nodeB: 7, thic: matProps[1].radius },
     { elemName: 'Elem1', nodeA: 7, nodeB: 8, thic: matProps[1].radius },
     { elemName: 'Elem2', nodeA: 3, nodeB: 4, thic: matProps[1].radius },
     { elemName: 'Elem3', nodeA: 4, nodeB: 5, thic: matProps[1].radius },
     { elemName: 'Elem4', nodeA: 0, nodeB: 1, thic: matProps[1].radius },
     { elemName: 'Elem5', nodeA: 1, nodeB: 2, thic: matProps[1].radius },
     { elemName: 'Elem6', nodeA: 6, nodeB: 4, thic: matProps[1].radius },
     { elemName: 'Elem7', nodeA: 7, nodeB: 4, thic: matProps[1].radius },
     { elemName: 'Elem8', nodeA: 7, nodeB: 5, thic: matProps[1].radius },
     { elemName: 'Elem9', nodeA: 5, nodeB: 8, thic: matProps[1].radius },
     { elemName: 'Elem10', nodeA: 3, nodeB: 1, thic: matProps[1].radius },
     { elemName: 'Elem11', nodeA: 1, nodeB: 4, thic: matProps[1].radius },
     { elemName: 'Elem12', nodeA: 4, nodeB: 2, thic: matProps[1].radius },
     { elemName: 'Elem13', nodeA: 5, nodeB: 2, thic: matProps[1].radius }];
